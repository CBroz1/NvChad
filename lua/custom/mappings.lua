...
-- https://github.com/NvChad/NvChad/issues/2688
...
map("i", "<C-w>",  "<ESC><cmd> wq <CR>", { desc = "write/quit" })
...
map("n", "<leader>nm", "<cmd> lua require('telescope').extensions.notify.notify() <CR>", { desc = "notification search" })
